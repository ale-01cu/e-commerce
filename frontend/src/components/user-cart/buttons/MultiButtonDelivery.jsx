...
export const MultiButtonDelivery = ({ actualizarTarifa }) => {
    ...
    const handleMunicipioChange = (event) => {
        ...
        const selectedMunicipioData = municipios.find((municipio) => municipio.municipio === selectedMunicipio);
    ...
    const handleZonaChange = (event) => {
        ...
        const selectedMunicipioData = municipios.find((municipio) => municipio.municipio === selectedMunicipio);
        const selectedZonaData = selectedMunicipioData.zonas.find((zona) => zona.zona === selectedZona);
    ...
    return (
        <>
            ...
            <select className="buttondelivery" onChange={handleZonaChange} value={selectedZona}>
